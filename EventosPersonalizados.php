...
$sql=$cn->prepare('SELECT I.Codigoinstitucion,I.Nombre as NombreInstitucion,E.CodigoEvento,E.Nombre as NombreEvento,E.Fecha,I.Imagen FROM evento E,organizador O,institucion I WHERE E.CodigoOrganizador=O.CodigoOrganizador AND O.CodigoInstitucion=I.CodigoInstitucion AND O.CodigoOrganizador=:CodigoOrganizador ORDER BY E.Fecha ASC' );
$sql->execute(array(':CodigoOrganizador'=>$cod));
...
<table width="250" height="150" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td height="101" colspan="2" scope="row"><a href="MuestraEvento.php?id=<?php echo $op['CodigoEvento'];?>" class="muestra1"><img src=<?php echo $op['Imagen'];?> width="57" height="65" border="0" style="padding:2px; margin-left:15px;" /></a></td>
    <td width="138" height="101" scope="row"><span class="Estilo1" style="text-align:left; margin-left:5px;"><?php echo $op['Fecha'];?></span></td>
    </tr>
